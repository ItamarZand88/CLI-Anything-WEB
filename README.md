...
| [`cli-web-youtube`](youtube/) | YouTube | InnerTube REST API | None | Search videos, video details, trending, channel info |
| [`cli-web-hackernews`](hackernews/) | Hacker News | REST API (Firebase + Algolia) | Cookie (optional) | Stories, search, comments, users, upvote, submit, comment, favorite |
