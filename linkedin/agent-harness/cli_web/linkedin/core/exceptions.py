"""Typed exception hierarchy for cli-web-linkedin.
...
class LinkedinError(Exception):
    """Base exception for all cli-web-linkedin errors."""
...
class ServerError(LinkedinError):
...
class NotFoundError(LinkedinError):
    """Resource not found (HTTP 404)."""


class RPCError(LinkedinError):
...
def _error_code_for(exc: LinkedinError) -> str:
