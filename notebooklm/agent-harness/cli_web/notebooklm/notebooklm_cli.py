...
def _print_repl_help():
    ...
    print()
    print("  Artifacts:")
    print("    artifacts generate [--notebook <id>] --type <t>  Generate artifact")
    print("      types: mindmap, study-guide, briefing, faq, timeline")
    print("      flags: --wait, --retry N, --output file.md")
    print("    artifacts generate-notes [--notebook <id>]     Generate study notes")
    print("    artifacts list-audio-types [--notebook <id>]   List audio types")
    print()
    print("  Account:")
